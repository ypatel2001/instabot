...
insta.set_do_comment(True, percentage=50)
insta.set_comments(["Nice!", "Sweet!", "Beautiful :heart_eyes:","That's Great!", "Wow!", "That is awesome!"])
...
insta.clarifai_check_img_for(['nsfw'])
